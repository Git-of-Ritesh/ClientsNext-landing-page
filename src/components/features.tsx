    ...
    return (
        <section className="dark:bg-muted/25 bg-zinc-50 py-16 md:py-32">
            <div className="mx-auto max-w-5xl px-6 flex flex-col justify-center items-center">
                ...
                <p className='text-muted-foreground text-sm text-center sm:text-md my-2 mb-18'>Customized CRM experience for your unique journey.</p>
                <div className="mx-auto grid gap-2 sm:grid-cols-5">
                    <Card className="group overflow-hidden shadow-zinc-950/5 sm:col-span-3 sm:rounded-none sm:rounded-tl-xl">
                        <CardHeader>
                            <div className="md:p-6">
                                <p className="font-medium">Lead Managment System</p>
                    ...
                    <Card className="group overflow-hidden shadow-zinc-950/5 sm:col-span-2 sm:rounded-none sm:rounded-tr-xl gap-2">
                        <p className="mx-auto mt-6 max-w-md text-balance px-6 text-center text-lg font-semibold sm:text-2xl md:pt-6">Advanced UX, Instantly Visualize Sales Pipelines.</p>
                        <p className='px-6 mx-auto max-w-md text-muted-foreground text-sm text-center'>Organize, prioritize, and close deals faster with visual pipelines.</p>
