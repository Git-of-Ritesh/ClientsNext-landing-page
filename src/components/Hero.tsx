...
const Hero = () => {
    return (
        <div className='flex flex-col pt-10 sm:pt-40 justify-center items-center'>
            ...
            <div className='flex flex-col mt-10 gap-2 sm:flex-row justify-center items-center'>
            ...
            <h1 className='sm:text-xl font-normal text-muted-foreground'>Join 10+ people on the waitlist</h1>
            </div>
